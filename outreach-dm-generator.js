  ...
  var TEMPLATES = {
    es: {
      A: ['Hola {name}! 👋',
          ...
          '👉 Registrate en: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
      ...
      B: ['Hey {name},',
          ...
          '👉 https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
          '',
      ...
      C: ['Hola {name}! Perdón el DM frío 🤍',
          ...
          '',
          'Código tuyo: {code}',
          '👉 Registrate: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
          '',
    ...
    pt: {
      A: ['Oi {name}! 👋',
          ...
          '👉 Cadastra-te em: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
      ...
      C: ['Oi {name}! Desculpa o DM frio 🤍',
          ...
          '',
          'Seu código: {code}',
          '👉 Cadastra-te: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
          '',
    ...
    it: {
      A: ['Ciao {name}! 👋',
          ...
          '👉 Registrati su: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
      ...
      C: ['Ciao {name}! Scusa il DM a freddo 🤍',
          ...
          '',
          'Codice tuo: {code}',
          '👉 Registrati: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
          '',
    ...
    en: {
      A: ['Hey {name}! 👋',
          ...
          '👉 Sign up at: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
      ...
      C: ['Hey {name}, sorry for the cold DM 🤍',
          ...
          '',
          'Your code: {code}',
          '👉 Sign up: https://shadownet-xi.vercel.app/creator-signup.html?code={code}',
          '',
