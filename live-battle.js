// live-battle.js - Creator-vs-creator live battles with gift-counter split-screen
...
(function(){
  ...
  function buildModal(){
    ...
    html += '<div class="lb-sub">Reta a otro creator en vivo. Los fans eligen al ganador con regalos.</div>';
  ...
  function showIncomingInvite(p){
    ...
    html += '<div class="lb-invite-msg">Te reta a un battle de <b>' + p.duration + ' minutos</b>.<br>Los fans deciden el ganador con regalos.</div>';
  ...
  function init(){
    ...
    listenForInvites();
    checkActiveOnLoad();
    console.debug('[live-battle] installed, isHost=' + isHost);
  }
